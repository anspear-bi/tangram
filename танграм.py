...
t.left(135)
draw_parallelogram('lightgreen', (-130, -255))
...
# канва
t.right(45)
draw_triangle_big ('red',(0,0))
t.left(45)
draw_triangle_big('yellow',(0,-106))
draw_parallelogram('green',(0,-106))
t.left(135)
draw_triangle_mini('pink',(75,-75))
